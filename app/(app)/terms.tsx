  ...
  return (
    <SafeAreaView style={{ flex: 1, backgroundColor: bgColor }}>
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        {/* Content */}
        <View className="mx-[18px] rounded-[18px] border border-gray-200 dark:border-line2 bg-white dark:bg-[#0C111E] p-[18px] mb-4">
          {activeTab === 'terms' && (
            <View className="gap-4">
              ...
              <View>
                ...
                <Text variant="body" className="text-gray-700 dark:text-text-primary ml-4 mt-1">
              ...
              <Text variant="caption" className="text-gray-500 dark:text-fg4 mt-4">
