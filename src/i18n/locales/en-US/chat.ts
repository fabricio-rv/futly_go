export const enUSChat = {
  ...
  infoScreen: {
    ...
    privateConversation: 'Private chat',
    user: 'User',
    group: 'Group',
    ...
    enableNotificationsBody: 'Do you want to enable notifications for this user?',
    disableNotificationsBody: 'Do you want to disable notifications for this user?',
    cancel: 'Cancel',
    enable: 'Enable',
    disable: 'Disable',
    notificationsError: 'Failed to update notifications.',
    contactPrefix: 'Contact',
    success: 'Success',
    contactShared: 'Contact shared.',
    shareError: 'Failed to share contact.',
    groupUpdateError: 'Failed to update group.',
    permissionTitle: 'Permission required',
    galleryPermission: 'Allow gallery access to change group photo.',
    ...
    leaveGroupBody: 'Do you really want to leave this group?',
    leaveGroup: 'Leave group',
    leaveGroupError: 'Failed to leave group.',
    groupDescriptionPlaceholder: 'Add group description',
    ...
    notificationsPrivateHint: 'Enable or disable notifications for this user',
    notificationsGroupHint: 'Enable or disable notifications for this group',
