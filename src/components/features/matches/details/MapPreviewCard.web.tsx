    ...
    <View className="my-2">
      ...
      >
        <View className="items-center">
          ...
          <Text className="text-zinc-400 font-medium">{t('details.openInGoogleMaps', 'Ver localização no Google Maps')}</Text>
        </View>
      </Pressable>
      ...
      {showAddressFooter && (
        <View className="bg-zinc-900/50 border border-zinc-800 rounded-[16px] p-3 mt-3 flex-row items-center">
          ...
          >
            <Text className="text-white font-bold">{t('details.route', 'Rota')}</Text>
          </Pressable>
        </View>
      )}
    </View>
