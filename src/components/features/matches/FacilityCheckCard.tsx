...
export function FacilityCheckCard({ label, selected, onPress }: FacilityCheckCardProps) {
  return (
    <Pressable onPress={onPress} className="rounded-[14px] border px-[14px] py-3 flex-row items-center gap-[10px]" style={{ backgroundColor: selected ? 'rgba(0,154,84,0.12)' : '#0C111E', borderColor: selected ? matchTheme.colors.ok : matchTheme.colors.lineStrong }}>
