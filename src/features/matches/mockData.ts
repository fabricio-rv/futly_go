...
export const playersSeed: Jogador[] = [
  { id: 'p1', name: 'Fabricio R.', initials: 'FR', ovr: 82, position: 'Pivo', gradient: ['#1B3A5F', '#071428'] },
  { id: 'p2', name: 'Luiz G.', initials: 'LG', ovr: 89, position: 'Fixo', gradient: ['#5A3018', '#2A160A'] },
  { id: 'p3', name: 'Carla S.', initials: 'CS', ovr: 87, position: 'Ala', gradient: ['#6C7487', '#20242E'] },
  { id: 'p4', name: 'Amanda M.', initials: 'AM', ovr: 76, position: 'Ala', gradient: ['#8B6CF5', '#3B2C7E'] },
  { id: 'p5', name: 'Pedro K.', initials: 'PK', ovr: 79, position: 'GK', gradient: ['#C69745', '#3A2A0B'], isHost: true },
];
